...
The primary objective up until now has been the Lane Departure Warning sensor. Relevant code is in the directory of the same name. In the future, different objectives of this project will gain their own folders.
