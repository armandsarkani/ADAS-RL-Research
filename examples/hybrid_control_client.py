...
class World(object):
    ...
    def tick(self, clock):
        ...
        player.apply_control(carla.VehicleControl(throttle=throttle, steer=0))
        while(player.is_at_traffic_light()):
...
def main():
    ...
    argparser.add_argument('-throttle', '--one')
    argparser.add_argument(
        '-a', '--autopilot',
        action='store_true',
